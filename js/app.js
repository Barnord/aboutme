...
let qArray=['Is my name Ben?','Do I live in Everett?','Am I 32 years old?','Did I go to Bothell High School?','Have I spent three years in Nicaragua farming potatoes?']
...
questionYes (qArray[0]);
questionNo (qArray[1]);
questionNo (qArray[2]);
questionYes (qArray[3]);
questionNo (qArray[4]);
numberGame();
riverGame();
